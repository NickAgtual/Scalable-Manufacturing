...
xlabel('\emph{Core Type}',...
    'fontsize', 14, 'Interpreter', 'Latex')
barGraph.legendLabels = {'Poplar', 'Aspen', 'Beech', 'Birch', ...
    'Poplar \& Beech', 'Poplar \& Birch', 'Aspen \& Beech', ...
    'Aspen \& Birch'};
legend(barGraph.legendLabels, 'location', 'southoutside', 'NumColumns', ...
    8, 'Interpreter', 'Latex')

% Using Latex interpreter for category labes
set(gca,'XTickLabel',barGraph.categories,'TickLabelInterpreter','latex');
...
xlabel('\emph{Core Type}',...
    'fontsize', 14, 'Interpreter', 'Latex')
legend(barGraph.legendLabels, 'location', 'southoutside', ...
    'NumColumns', 8, 'Interpreter', 'Latex')
